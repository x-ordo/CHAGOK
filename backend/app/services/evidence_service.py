...
class EvidenceService:
    ...
    def get_evidence_list(
        ...
        summaries = [
            EvidenceSummary(
                ...
                created_at=datetime.fromisoformat(evidence["created_at"].replace("Z", "+00:00")),
    ...
    def get_evidence_detail(self, evidence_id: str, user_id: str) -> EvidenceDetail:
        ...
        return EvidenceDetail(
            ...
            timestamp=datetime.fromisoformat(evidence["timestamp"].replace("Z", "+00:00")) if evidence.get("timestamp") else None,
